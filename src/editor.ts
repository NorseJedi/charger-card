        ...
        return html`
            ...
            >
                ...
                ${Object.values(CARDTEMPLATES).map((cfg: template) => {
                    return html`
                        <mwc-list-item .value=${cfg.config.domain}>${cfg.config.name}</mwc-list-item>`;
                })}
            </mwc-select>
            ...
            >
                ${Object.values(cconst.CARD_THEMES).map(theme => {
                    return html`
                        <mwc-list-item .value=${theme.name}>${theme.desc}</mwc-list-item>`;
                })}
            </mwc-select>
            ...
            >
                ${Object.keys(cconst.CHARGER_IMAGES).map(chargerImage => {
                    return html`
                        <mwc-list-item .value=${chargerImage}>${chargerImage}</mwc-list-item>`;
                })}
            </mwc-select>
            ...
            <mwc-formfield
                .label=${localize(this._compact_view ? 'editor.compact_view_aria_label_off' : 'editor.compact_view_aria_label_on')}>
                <mwc-switch
            ...
            <mwc-formfield
                .label=${localize(this._show_name ? 'editor.show_name_aria_label_off' : 'editor.show_name_aria_label_on')}>
                <mwc-switch
            ...
            <mwc-formfield
                .label=${localize(this._show_leds ? 'editor.show_leds_aria_label_off' : 'editor.show_leds_aria_label_on')}>
                <mwc-switch
            ...
            <mwc-formfield
                .label=${localize(this._show_status ? 'editor.show_status_aria_label_off' : 'editor.show_status_aria_label_on')}>
                <mwc-switch
            ...
            <mwc-formfield
                .label=${localize(this._show_collapsibles ? 'editor.show_collapsibles_aria_label_off' : 'editor.show_collapsibles_aria_label_on')}>
                <mwc-switch
            ...
            <mwc-formfield
                .label=${localize(this._show_stats ? 'editor.show_stats_aria_label_off' : 'editor.show_stats_aria_label_on')}>
                <mwc-switch
            ...
            <mwc-formfield
                .label=${localize(this._show_toolbar ? 'editor.show_toolbar_aria_label_off' : 'editor.show_toolbar_aria_label_on')}>
                <mwc-switch
